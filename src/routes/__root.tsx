...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Tinta — Crie mangás com IA" },
      { property: "og:description", content: "Da ideia ao PDF: roteiro, personagens, storyboard e páginas com consistência visual." },
